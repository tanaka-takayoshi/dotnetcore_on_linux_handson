...
namespace AspNetCorehandson
{
    public partial class PubsEntities : DbContext
    {
        ...
        {
            //options.UseSqlite($"Filename={Startup.App_Data}/pubs.db");
            options.UseSqlServer(
                $@"data source=(LocalDB)\mssqllocaldb;attachdbfilename={Startup.App_Data}\pubs.mdf;MultipleActiveResultSets=True;App=EntityFramework");
        }
